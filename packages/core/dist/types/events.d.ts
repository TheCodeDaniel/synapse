 ...
 */
export type EventType = 'project.imported' | 'design.compiled' | 'project.analyzed' | 'plan.generated' | 'widget.generated' | 'validation.completed' | 'integration.completed' | 'error' | 'progress';
...
export type CoreEvent = ProjectImportedEvent | DesignCompiledEvent | ProjectAnalyzedEvent | PlanGeneratedEvent | WidgetGeneratedEvent | ValidationCompletedEvent | IntegrationCompletedEvent | ErrorEvent | ProgressEvent;
