...
export type DesignNode = DocumentNode | FrameNode | ComponentNode | VariantNode | InstanceNode | TextNode | ShapeNode | GroupNode | SliceNode;
...
//# sourceMappingURL=design.graph.d.ts.map